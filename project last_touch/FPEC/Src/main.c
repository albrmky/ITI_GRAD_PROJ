...
int main(void)
{
	...
	u32 ID_tx = CAN_u32GetProperFilterValues(0x200, 0x525, 0, 0); // the identifier which this ECU will use to send data to WIFI ECU
	...
	MSYSTICK_voidInit();
	MSYSTICK_voidSetIntervalSingle(16000000, func);
