...
#include "../../include/MCAL/USART/USART_CONFIG.h"
#include "../../include/MCAL/USART/USART_REG.h"
...
void MUSART_VidInit ( void ){
	...
	if( LOC_u64Fraction > 1500 ){ LOC_u64Mantissa += 1 ; LOC_u64Fraction  = 0 ; }
		...
		MUSART1 -> SR = 0;
					...
					CLEAR_BIT( MUSART1 -> CR1 , 5 );
					CLEAR_BIT( MUSART1 -> CR1 , 6 );
					CLEAR_BIT( MUSART1 -> CR1 , 7 );
					...
					SET_BIT( MUSART1 -> CR2 , 12 ); CLEAR_BIT( MUSART1 -> CR2 , 13 );

		#elif USART1_STOP_BITS == TWO_STOP_BIT

					CLEAR_BIT( MUSART1 -> CR2 , 12 ); SET_BIT( MUSART1 -> CR2 , 13 );
